...
**Class Website**: A class website <TBD> will be used throughout the course and should be checked on a regular basis for lecture materials and required readings.

**Class Slack Channel**: The class also has a dedicated slack channel (TBD). The channel serves as an open forum to discuss, collaborate, pose problems/questions, and offer solutions. Students are encouraged to pose any questions they have there as this will provide the professor and TA the means of answering the question so that all can see the response. If you're unfamiliar with, please consult the following start-up tutorial (https://get.slack.help/hc/en-us/articles/218080037-Getting-started-for-new-members). Please follow the [***invite link***](https://join.slack.com/t/ppol5203fall2023/shared_invite/zt-2159njh4n-S4u1yonz4dA7Zxyo2n3bjA) to be added to the Slack channel.
...
**Topics:** How do we evaluate complexity in text? Why should we care about complexity in text?
How do we evaluate similarity in text? Why is this useful?
...
- David M. Blei . 2012. “Probabilistic Topic Models.” http://www.cs.columbia.edu/~blei/papers/
Blei2012.pdf
...
- **Applied Papers**: 
    ...
    -  Rodman, E., 2020. A Timely Intervention: Tracking the Changing Meanings of Political Concepts
with Word Vectors. Political Analysis, 28(1), pp.87-111.
...
- **Step 4**: Replication Repository
  ...
  - By Friday EOD of each replication week, you should share with me and all your colleagues your replication report. The replication report should be: 
    - a github repo with a well-detailed readme. See an model here: [https://github.com/TiagoVentura/winning_plosone](https://github.com/TiagoVentura/winning_plosone)
