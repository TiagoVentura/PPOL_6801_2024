...
- $S_{vd}$ weighted average of the scores by word frequency.
...
with latent variables: - $\theta_i$ measures ideology of user i - $\phi_j$ measures ideology of political account j

And: - $\alpha_j$ measures popularity of political account j - $\beta_i$ measures political interest of user i
