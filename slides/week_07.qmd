...
## Back to class II: Vector Space Model
...
Embedded in this model, there is the idea we represent [words]{.red} as a one-hot encoding. 
...
- [GloVe]{.red} are trained on different things: Wikipedia
(2014) + Gigaword (6B words), Common Crawl, Twitter
